    ...
    <div className='panel-body'>
      <table className='table table-user-information' style={{marginBottom: '0px'}}>
        <tbody>
          ...
          <tr>
            <td><button onClick={this.handleSaveClick} className='btn btn-md btn-default' style={{marginRight: '20px'}}><i className='glyphicon glyphicon-floppy-disk' /> Save</button>
              <button onClick={this.handleCancelClick} className='btn btn-md btn-default'><i className='glyphicon glyphicon-remove' /></button>
            </td>
            <td />
          </tr>
        </tbody>
