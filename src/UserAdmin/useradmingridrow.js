...
var UserAdminGridRow = React.createClass({
  ...
  <tr className='tableRowSpace'>
    ...
    <td><button onClick={this.handleDetailClick} className='btn btn-md btn-default'><i className='glyphicon glyphicon-info-sign' /> Details</button></td>
    <td><button onClick={this.handleShowPermissions} className='btn btn-md btn-default'><i className='glyphicon glyphicon-eye-open' /> Permissions</button></td>
