        ...
        if (this.state.isEditMode) {
            return (
             <tr>
                ...
                <td><button onClick={this.handleSaveClick.bind(this, this.props.detail, this.state.name)} className="btn btn-sm btn-default"><i className="glyphicon glyphicon-floppy-disk"></i></button></td>
