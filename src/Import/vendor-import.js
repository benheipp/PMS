    ...
    render: function () {
      ...
      return (
            ...
            <div className="modal-header" style={{ backgroundColor: 'rgb(51, 122, 183)', color: 'white' }}><h4 className="modal-title">Vendor Source Import</h4></div>
                        ...
                        <div className="row">
                          <div className="col-sm-3">
                            <button disabled={this.state.status.importing} className="btn btn-success" onClick={this.handleImportClick}><span className="glyphicon glyphicon-arrow-up" aria-hidden="true"></span> Import</button>
                          </div>
                          <div className="col-sm-3">
                            <button disabled={!this.state.status.importing} type="button" className="btn btn-danger" onClick={this.handleCancelClick}><span className="glyphicon glyphicon-remove" aria-hidden="true"></span> Cancel</button>
                          </div>
                        </div>
                        <div className="row">
