    ...
    login(email, pass, cb) {
        ...
        loginRequest(email, pass, (res) => {
            if (res.authenticated) {
                ...
                if (typeof res.permissions.find(this.findCatalogVisibility) !== 'undefined')
                {localStorage.CatalogVisibility = "true"; } else{ localStorage.CatalogVisibility = "false"; }

                if (typeof res.permissions.find(this.findProductVisibility) !== 'undefined')
                {localStorage.ProductVisibility = "true"; } else{ localStorage.ProductVisibility = "false"; }

                if (typeof res.permissions.find(this.findStoreEditing) !== 'undefined')
                {localStorage.StoreEditing = "true"; } else{ localStorage.StoreEditing = "false"; }

                if (typeof res.permissions.find(this.findCatalogEditing) !== 'undefined')
                {localStorage.CatalogEditing = "true"; } else{ localStorage.CatalogEditing = "false"; }

                if (typeof res.permissions.find(this.findProductEditing) !== 'undefined')
                {localStorage.ProductEditing = "true"; } else{ localStorage.ProductEditing = "false"; }
